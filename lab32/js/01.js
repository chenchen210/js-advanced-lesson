// ES5中使用构造函数定义并生成新的对象   Part1111111111
function Point(x,y){
    this.x=x;
    this.y=y;
}
...
// ES6 中的class语法  Part 222222222222222222
class Point{
    constructor(){
        this.x=1;
        this.y=2;
        var private_z=3;
        this.d=function(){
            console.log(this.x,this.y,private_z);//可以访问私有成员
        }
    }
    show(){
        // console.log("show:",this.x,this.y,private_z);//报错，因为无法访问私有成员
